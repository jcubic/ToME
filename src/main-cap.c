...
static s32b rows; 	/* Screen size (Y) */
static s32b cols; 	/* Screen size (X) */
static s32b curx; 	/* Cursor location (X) */
static s32b cury; 	/* Cursor location (Y) */
static s32b curv; 	/* Cursor visibility */
 ...
 */
static void do_cs(s32b y1, s32b y2)
{
 ...
 */
static void do_cm(s32b x, s32b y)
{
 ...
 */
static void do_move(s32b x1, s32b y1, s32b x2, s32b y2)
{
 ...
 * Suspend/Resume
 */
static errr Term_xtra_cap_alive(s32b v)
{
	/* Suspend */
	if (!v)
	{
 ...
 * Process an event
 */
static errr Term_xtra_cap_event(s32b v)
{
	s32b i, arg;
	char buf[2];
 ...
 */
static errr Term_curs_cap(s32b x, s32b y)
{
 ...
 */
static errr Term_wipe_cap(s32b x, s32b y, s32b n)
{
	s32b dx;
 ...
 */
static errr Term_text_cap(s32b x, s32b y, s32b n, byte a, cptr s)
{
	s32b i;
 ...
 */
static errr Term_xtra_cap(s32b n, s32b v)
{
	/* Analyze the request */
	switch (n)
	{
