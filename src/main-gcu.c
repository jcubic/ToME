 ...
 */
static s32b can_use_color = FALSE;

/*
 * Software flag -- we are allowed to change the colors
 */
static s32b can_fix_color = FALSE;

/*
 * Simple Angband to Curses color conversion table
 */
static s32b colortable[16];
 ...
 * Suspend/Resume
 */
static errr Term_xtra_gcu_alive(s32b v)
{
	s32b x, y;
 ...
 */
static errr Term_xtra_gcu_event(s32b v)
{
	s32b i, k;
 ...
 */
static errr Term_xtra_gcu(s32b n, s32b v)
{
 ...
 */
static errr Term_curs_gcu(s32b x, s32b y)
{
	term_data *td = (term_data *)(Term->data);
 ...
 */
static errr Term_wipe_gcu(s32b x, s32b y, s32b n)
{
	term_data *td = (term_data *)(Term->data);
 ...
 */
static errr Term_text_gcu(s32b x, s32b y, s32b n, byte a, cptr s)
{
	term_data *td = (term_data *)(Term->data);
 ...
 */
static errr term_data_init_gcu(term_data *td, s32b rows, s32b cols, s32b y, s32b x)
{
	term *t = &td->t;
 ...
 */
errr init_gcu(s32b argc, char **argv)
{
	s32b i;

	s32b num_term = MAX_TERM_DATA, next_win = 0;
	...
	can_redefine_color = (can_use_color && can_change_color() &&
	...
	can_fix_color = can_redefine_color;
