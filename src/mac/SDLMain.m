...
static void CustomApplicationMain (int argc, char **argv)
{
    ...
    /* Tell ToME where to find its stuff */
    NSString *cfgPath = [[NSBundle mainBundle] resourcePath];
    macToMEConfigPath = malloc([cfgPath length] + 1);
    strcpy(macToMEConfigPath, [cfgPath UTF8String]);
