/*
** $Id: ldo.c,v 1.8 2004/07/24 01:08:21 darkgod Exp $
...
extern int my_fprintf(PHYSFS_file *stream, const char *format, ...);
extern int my_physfs_fputc(int c, PHYSFS_file *stream);
extern int my_physfs_fgetc(PHYSFS_file *stream);
