/*
** $Id: lcode.c,v 1.4 2004/07/09 23:13:37 darkgod Exp $
...
const struct OpProperties luaK_opproperties[NUM_OPCODES] = {
  ...
  {iS, 0, 3},	/* OP_LFORLOOP */
  {iAB, VD, 0},	/* OP_CLOSURE */
  {iS, 3, 0},	/* OP_LISTFORPREP */
  {iS, 0, 4}	/* OP_LISTFORLOOP */
};
