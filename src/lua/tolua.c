...
** TeCGraf/PUC-Rio
** Jul 1998
** $Id: tolua.c,v 1.4 2004/03/12 20:13:07 darkgod Exp $
*/
...
/*
 * Fool io.c into linking and not bothering with anyway not present module code
 */
unsigned char module_initialized = 0;
unsigned char call_lua(const char *function, const char *args, const char *ret, ...)
{
	function = function;
	args = args;
	ret = ret;
