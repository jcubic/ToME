 ...
 * Hack -- see below
 */
void init_pair (s32b index, char *foreground, char *background)
{
 ...
 */
static errr Term_xtra_sla_event(s32b v)
{
 ...
 * Suspend / Resume
 */
static errr Term_xtra_sla_alive(s32b v)
{
	/* Suspend */
	if (!v)
	{
 ...
 */
static errr Term_xtra_sla(s32b n, s32b v)
{
	/* Analyze the request */
	switch (n)
	{
 ...
 */
static errr Term_text_sla(s32b x, s32b y, s32b n, byte a, cptr s)
{
	/* Move the cursor */
	SLsmg_gotorc(y, x);
