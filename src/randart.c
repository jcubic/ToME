...
#if 0 // DGDGDGDG: lazy I am, latter it will be

/*
 * Attempt to add a power to a randart
 */
static bool grab_one_power(s32b *ra_idx, object_type *o_ptr, bool good, s16b *max_times)
{
	s32b i = 0, j;
	s32b *ok_ra, ok_num = 0;
	bool ret = FALSE;
